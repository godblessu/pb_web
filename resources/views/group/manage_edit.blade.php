            ...
            <div class="m-form">
                ...
                <div class="formitm auth-box">
                    ...
                    <div class="form-control @if ($group->mode != 'paid') f-dn @endif j-sub1">
                        ...
                        <input min="1" oninput="value=moneyLimit(value)" class="iptline f-mr10" name="money" type="text" value="{{$group->money}}" /><span class="s-fc4">{{ $config['bootstrappers']['site']['gold_name']['name'] }}</span>
                    </div>
                </div>
                <div class="formitm">
